	...
	?>
		...
		<article>
			...
			<table >
					...
					<tr> 
						<td> <img src="../images/user/<?php echo $image; ?>" style="height:200px;width:200px;" /> </td>
						
						<td> <img src="../images/user/<?php echo $visa_image; ?>" style="height:200px;width:200px;" /> </td>
					</tr>
			...
			<center> Total: BDT <?php echo $total; ?> </center>
			
		</article>
		<aside>
			<h1><span >Contact us</span></h1>
			<div >
				<p align="center">Email :- info@suitehotel.com || Web :- www.suitehotel.com || Phone :- +8801303802470 </p>
			</div>
		</aside>
	</body>
</html>
