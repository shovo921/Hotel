    ...
    <div class="col-md-12"> 
      ...
      <div class="card">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><i class="fa fa-user"></i>  <span>Register User</span> <span class="badge"><?php echo $number2 ; ?></span></a></li>
