    ...
    <div class="site-section bg-light">
      <div class="container">
		...
		<?php 	
						...
						$sql = "SELECT bed.sl_id,bed.bed_no,bed.room_id,bed.status,bed.bed_image,add_room.type,add_room.name,add_room.image,add_room.id,add_room.price from add_room INNER JOIN bed on add_room.id = bed.room_id";
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="view_details.php?id=<?php echo $id ;?>" ><?php echo $name;?></a></h3>
